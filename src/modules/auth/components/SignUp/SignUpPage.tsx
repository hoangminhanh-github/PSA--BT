...
const SignUpPage = () => {
  ...
  return (
    <section>
      <img src={logo} alt="" />
    <form 
      className="infoform" onSubmit={formik.handleSubmit}>
      ...
      {formik.errors.password && formik.touched.password && (
        ...
        <div className="alert alert-danger">
          <label> <FormattedMessage id='minPasswordInvalid'/> </label>
        </div>
      )}
      {/* <label> Confirm Password </label> */}
      <label> <FormattedMessage id='repeatPassword'/> </label>
      <input
        type="text"
        id="repeatPassword"
        name="repeatPassword"
      ...
      {formik.errors.repeatPassword && formik.touched.repeatPassword && (
        ...
        <div className="alert alert-danger">
          <label> <FormattedMessage id='matchPasswordRequire'/> </label>
        </div>
      ...
      <label> <FormattedMessage id='state'/> </label>
